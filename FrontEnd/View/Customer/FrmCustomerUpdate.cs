...
namespace FrontEnd.View.Customer
{
    public partial class FrmCustomerUpdate : Form
    {
        ...
        //private int  NeighborhoodModelCod() 
        //{
        //    int cod = customer.Neighborhood.CodNeighborHood;  
        //    return cod;
        //}
        ...
        private async Task LoadComboAsync(CustomerModel customer)
        {
            try
            {
                ...
                // Buscar el índice del vecindario del cliente en la lista
                int index = neighborhoodLst.FindIndex(n => n.CodNeighborHood == customerNeighborhoodCode);

                // Configurar el índice del ComboBox
                cboNeighborhood.SelectedIndex = index >= 0 ? index : 0;
            }
            catch (Exception ex)
            {
        ...
        //        cboNeighborhood.SelectedIndex = NeighborhoodModelCod();
